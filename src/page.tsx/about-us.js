...
export default function Page() {
    return (
      <InnerPageContainer title="About Us">
            ...
            <p className="mt-8">
            Welcome to  My Company , where innovation meets design! We are a cutting-edge company that is passionate about transforming design into a seamless, imaginative, and enjoyable experience for everyone. Our mission is to empower you with AI-driven ideas.
            </p>
